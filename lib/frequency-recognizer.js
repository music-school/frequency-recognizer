...
const FrequencyRecognizerNodeWrapper = (() => {
  ...
  function createInstance(audioContext, recognizer, recognizerListener) {
    const object = new FrequencyRecognizerNode(audioContext, recognizer, recognizerListener);
    return object;
  }

  return {
    getInstance: (audioContext, recognizer, recognizerListener) => {
      if (!instance) {
        instance = createInstance(audioContext, recognizer, recognizerListener);
      }
      return instance;
    }
  };
